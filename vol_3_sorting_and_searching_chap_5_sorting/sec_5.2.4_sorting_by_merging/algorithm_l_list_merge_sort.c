...
static void usage()
{
  puts("usage:algorithm_l_list_merge_sort <in.dat >out.dat");
  ...
  puts("");
  puts("examples:");
  puts("algorithm_l_list_merge_sort <data/algorithm_l_list_merge_sort/in.0.le.dat | od -An -td8 -w8 -v");
}
